...
void VIRTUAL_DTMC::dtmc_body(Global *myp, const char *mysysname) {
...
VIRTUAL_DTMC::VIRTUAL_DTMC(Global *myp, const char *mysysname)  {
...
int VIRTUAL_DTMC::xsize() {return(2);}  // state size

int VIRTUAL_DTMC::usize() {return(2);}  // input size

int VIRTUAL_DTMC::ysize() {return(2);}  // output size
